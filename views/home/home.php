    ...
    <div class="modal-dialog" style="width:55%">
        <div class="modal-content">
            ...
            <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="landline_number" class="col-lg-2 control-label">Landline Number</label>
                        <div class="col-lg-10">
                            <input type="text" class="form-control" name="landline_number" id="landline_number" placeholder="Landline Number">
                        </div>
                    </div>
            ...
            <div class="modal-footer">
                ...
                <button type="button" id="submit_frm_add_new_contact" class="btn btn-primary">Save</button>
            </div>
            </form>
        </div>
    </div>
            ...
            <form class="form-horizontal" name="frm_edit_contact" id="frm_edit_contact" enctype="multipart/form-data" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="inputEmail" class="col-lg-2 control-label">Email</label>
                        <div class="col-lg-10">
                            <input type="text" class="form-control" name='edit_inputEmail' id="edit_inputEmail" placeholder="Email">
                    ...
                    <div class="form-group">
                        <label for="middle_name" class="col-lg-2 control-label">Middle Name</label>
                        <div class="col-lg-10">
                            <input type="text" class="form-control" name="edit_middle_name" id="edit_middle_name" placeholder="Middle Name">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label for="landline_number" class="col-lg-2 control-label">Landline Number</label>
                        <div class="col-lg-10">
                            <input type="text" class="form-control" name="edit_landline_number" id="edit_landline_number" placeholder="Landline Number">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label for="Note" class="col-lg-2 control-label">Note</label>
                        <div class="col-lg-10">
                            <textarea class="form-control" rows="3" name="edit_Note" id="edit_Note"></textarea>
                        </div>
                    </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" id="submit_frm_edit_contact" class="btn btn-primary">Save</button>
                </div>
            </form>
        </div>
    </div>
...
<script>
    ...
    $("#inputEmail,#first_name,#middle_name,#last_name,#moblie_number,#landline_number,#Note").keyup(function(){
